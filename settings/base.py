...
PUBLIC_PATH = os.path.join(BASE_DIR, 'keys/public.txt')
PRIVATE_PATH = os.path.join(BASE_DIR, 'keys/private.txt')
...
LOGGING = {
    ...
    'handlers': {
        'excel': {
            'level': 'INFO',
            'class': 'settings.logger.ExcelFileHandler',
            'filename': 'serv_logs.xlsx',
        },
    },
    'root': {
        'handlers': ['excel'],
